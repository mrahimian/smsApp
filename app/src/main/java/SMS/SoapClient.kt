...
(private val Username: String, private val Password: String) {
    ...
    fun SendSimpleSMS2 (to: String, from: String, text: String, isFlash: Boolean) : Any? {
        ...
        try {
            response = getXMLResult(SEND_URL, SOAP_ACTION, request)
        }catch (e:Exception){
            e.printStackTrace()
            Log.e("EROOOOR","ERR")
            response = getXMLResult(SEND_URL2, SOAP_ACTION, request)
        }
    ...
    companion object {
        ...
        private val SEND_URL = "https://api.payamak-panel.com/post/send.asmx"
        private val SEND_URL2 = "http://api.payamak-panel.com/post/send.asmx"
